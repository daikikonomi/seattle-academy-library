...
public class UsersService {
    ...
    public UserInfo selectUserInfo(String email, String password) {
        // TODO SQL生成
        String sql = "select email, password from users whrere email = '" + email + "', password = '" + password + "'";
        
        try {UserInfo selectUserInfo = jdbcTemplate.queryForObject(sql, new UserCountRowMapper());
